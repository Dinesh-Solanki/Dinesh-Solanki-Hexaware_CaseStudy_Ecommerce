...
namespace Ecom_Application_Test
{
    public class Ecom_Application_Testing
    {
        ...
        [Test]
        public void AddedToCart_WhenPassed()
        {
            Customers customers = new Customers() { Customer_id = 4 };
        ...
        [Test]
        public void AddedToCart_WhenFailed()
        {
        ...
        [Test]
        public void OrderPlaced_WhenPassed() 
        {
            Customers customers = new Customers() { Customer_id = 1 };
            Products products=new Products() { Product_id = 100 };
            int quantity = 10;
        ...
        [Test]
        public void OrderPlaced_WhenFailed()
        {
